...
class NNList(models.Model):
    ...
    train = models.InteagerField(max_length=1, blank=True, default='')           # if trained model exist
    config = models.InteagerField(max_length=1, blank=True, default='')          # if config exist
